...
-- 3. scene_evaluation_criteriaテーブルが存在しない場合は作成
...
-- 6. トリガーを作成（存在しない場合）
DROP TRIGGER IF EXISTS update_scene_evaluation_criteria_updated_at ON scene_evaluation_criteria;
